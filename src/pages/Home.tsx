          ...
          <div className="grid md:grid-cols-4 gap-8">
            <Card className="hotel-card hover-lift text-center animate-scale-in">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">We guarantee the best prices for your hotel bookings</p>
              </CardContent>
            </Card>
            <Card className="hotel-card hover-lift text-center animate-scale-in" style={{ animationDelay: '0.1s' }}>
              <CardContent className="p-6">
            ...
            <Card className="hotel-card hover-lift text-center animate-scale-in" style={{ animationDelay: '0.2s' }}>
              <CardContent className="p-6">
                <Star className="w-12 h-12 mx-auto mb-4 text-primary" />
                <h3 className="text-xl font-semibold mb-2">Premium Hotels</h3>
                <p className="text-muted-foreground">Handpicked selection of luxury and comfort accommodations</p>
              </CardContent>
            </Card>
            <Card className="hotel-card hover-lift text-center animate-scale-in" style={{ animationDelay: '0.3s' }}>
              <CardContent className="p-6">
                <Users className="w-12 h-12 mx-auto mb-4 text-primary" />
                <h3 className="text-xl font-semibold mb-2">Trusted by Millions</h3>
                <p className="text-muted-foreground">Join millions of satisfied customers worldwide</p>
              </CardContent>
            </Card>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <Card className="hotel-card hover-lift overflow-hidden animate-scale-in">
              <div className="relative">
                <img src="/placeholder.svg" alt="Central Park" className="w-full h-48 object-cover" />
            ...
            <Card className="hotel-card hover-lift overflow-hidden animate-scale-in" style={{ animationDelay: '0.1s' }}>
              <div className="relative">
                <img src="/placeholder.svg" alt="Times Square" className="w-full h-48 object-cover" />
                <div className="absolute top-3 left-3 bg-primary/90 text-white px-2 py-1 rounded text-sm">
                  1.2 km
                </div>
              </div>
              <CardContent className="p-4">
                ...
                <p className="text-sm text-muted-foreground">Tourist Attraction</p>
              </CardContent>
            </Card>
            <Card className="hotel-card hover-lift overflow-hidden animate-scale-in" style={{ animationDelay: '0.2s' }}>
              <div className="relative">
                <img src="/placeholder.svg" alt="Metropolitan Museum" className="w-full h-48 object-cover" />
                <div className="absolute top-3 left-3 bg-primary/90 text-white px-2 py-1 rounded text-sm">
                  2.1 km
                </div>
              </div>
            ...
            <Card className="hotel-card hover-lift overflow-hidden animate-scale-in" style={{ animationDelay: '0.3s' }}>
              <div className="relative">
                <img src="/placeholder.svg" alt="Empire State Building" className="w-full h-48 object-cover" />
                <div className="absolute top-3 left-3 bg-primary/90 text-white px-2 py-1 rounded text-sm">
                  1.8 km
                </div>
              </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="hotel-card hover-lift overflow-hidden animate-scale-in">
              <div className="relative">
                <img src="/placeholder.svg" alt="Grand Plaza Hotel" className="w-full h-64 object-cover" />
              ...
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold mb-2">Grand Plaza Hotel</h3>
            ...
            <Card className="hotel-card hover-lift overflow-hidden animate-scale-in" style={{ animationDelay: '0.1s' }}>
              <div className="relative">
                <img src="/placeholder.svg" alt="Ocean View Resort" className="w-full h-64 object-cover" />
                <div className="absolute top-4 right-4 bg-white/90 px-3 py-1 rounded-full">
                  <div className="flex items-center space-x-1">
                    <Star className="w-4 h-4 text-yellow-500 fill-current" />
              ...
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold mb-2">Ocean View Resort</h3>
            ...
            <Card className="hotel-card hover-lift overflow-hidden animate-scale-in" style={{ animationDelay: '0.2s' }}>
              <div className="relative">
                <img src="/placeholder.svg" alt="Urban Loft Hotel" className="w-full h-64 object-cover" />
                <div className="absolute top-4 right-4 bg-white/90 px-3 py-1 rounded-full">
                  <div className="flex items-center space-x-1">
                    <Star className="w-4 h-4 text-yellow-500 fill-current" />
